...
const translations = {
    es: {
        ...
        "portfolio.p1.desc": "Una pagina web desarrollada para un refugio de animales llamado 'Marcando Huellitas', con el objetivo de promover la adopción de perros. En esta puedes encontrar informacion sobre los perros disponibles para adopción, sus historias, caracteristicas y como adoptarlos.",
        "portfolio.p2.tag": "ASEA Agencia de Seguridad, Energía y Ambiente",
        "portfolio.p2.desc": "RENAGAS Fase 2 (o la segunda etapa del Registro Nacional de Gasolineras y Plantas de GLP) es un programa extraordinario de regularización ambiental implementado por la Agencia de Seguridad, Energía y Ambiente (ASEA) en México. Requiere que las gasolineras y plantas de GLP actualicen sus datos, utilicen firmas electrónicas y cumplan con sus obligaciones ambientales.",
        "portfolio.p3.desc": "Una landing page dinámica desarrollada para un Hackathon. Diseñada para apasionados del básquetbol, ofrece una experiencia de usuario fluida, interfaces responsivas y un diseño moderno que atrapa la esencia del deporte.",
        "portfolio.p4.tag": "ULA Universidad Latinoamericana",
        "portfolio.p4.title1": "Inventario",
        "portfolio.p4.desc": "Este proyecto consiste en un sistema de control de inventario para los equipos de laboratorio de la Universidad Latinoamericana y de esta manera se pueda tener un mejor control de los equipos de laboratorio y de esta manera facilitar el trabajo de los docentes y alumnos.",
        "portfolio.p5.tag": "Portafolio",
        "portfolio.p5.desc": "Mi pagina web en la cual muestro mi informacion personal, mis habilidades, proyectos en los que he trabajado y como contactarme.",
        "portfolio.btn.demo": "Demo del Proyecto",
        "portfolio.btn.code": "Código Fuente",
        "portfolio.btn.web": "Ver página web",
        "gallery.item1.title": "Primeros Pasos",
        "gallery.item1.desc": "Recordando donde empezó todo. Cada pequeño paso cuenta.",
        "gallery.item2.title": "Lazos Verdaderos",
        "gallery.item2.desc": "Los mejores ratos se viven con la mejor compañía. Instantes que se vuelven inolvidables.",
        "gallery.item3.title": "Próximo Destino: Japón",
        "gallery.item3.desc": "Una meta clara en el horizonte. Una cultura que admiro y un sueño que pronto será realidad.",
        "gallery.item4.title": "Comunidad Tech",
        "gallery.item4.desc": "He tenido la oportunidad de conocer a personas increíbles como Brais (MoureDev). El aprendizaje en comunidad es mi motor.",
        "gallery.item5.title": "Pura Adrenalina",
        "gallery.item5.desc": "Salir de la zona de confort. Me encantan los retos extremos, ya sea un salto en paracaídas o un bug difícil.",
        "gallery.item6.title": "Liderazgo",
        "gallery.item6.desc": "Durante mi carrera logré formar una gran comunidad. Crecer en equipo es clave para el éxito.",
        "gallery.item7.title": "Licenciatura",
        "gallery.item7.desc": "Orgulloso de haberme graduado con excelencia, cerrando un ciclo impecable en el Politécnico.",
        "gallery.item8.title": "Espíritu Aventurero",
        "gallery.item8.desc": "Viajar y descubrir nuevos lugares es mi pasión. Cada destino es una nueva perspectiva del mundo.",
        "footer.title": "Explora las profundidades",
        "footer.desc": "Gracias por sumergirte en mi portafolio. Siempre estoy buscando nuevos océanos de código por explorar y proyectos desafiantes.",
        "footer.contact": "¡Hablemos de tu próximo proyecto!",
        "footer.copyright": "© 2026 Perucho Dev. Todos los derechos reservados.",
        "footer.lights": "¡Enciende las luces!"
    },
    en: {
        "nav.home": "Home",
        "nav.about": "About",
        ...
        "portfolio.p1.desc": "A website developed for an animal shelter called 'Marcando Huellitas', with the goal of promoting dog adoption. Here you can find information about dogs available for adoption, their stories, characteristics, and how to adopt them.",
        "portfolio.p2.tag": "ASEA Agencia de Seguridad, Energía y Ambiente",
        "portfolio.p2.desc": "RENAGAS Phase 2 (or the second stage of the National Registry of Gas Stations and LPG Plants) is an extraordinary environmental regularization program implemented by the Agency for Safety, Energy and Environment (ASEA) in Mexico. It requires gas stations and LPG plants to update their data, use electronic signatures, and comply with their environmental obligations.",
        "portfolio.p3.desc": "A dynamic landing page developed for a Hackathon. Designed for basketball enthusiasts, it offers a seamless user experience, responsive interfaces, and a modern design that captures the essence of the sport.",
        "portfolio.p4.tag": "ULA Universidad Latinoamericana",
        "portfolio.p4.title1": "Inventory",
        "portfolio.p4.desc": "This project consists of an inventory control system for laboratory equipment at the Universidad Latinoamericana, allowing for better control of the equipment and thus facilitating the work of teachers and students.",
        "portfolio.p5.tag": "Portfolio",
        "portfolio.p5.desc": "My personal website where I showcase my personal information, skills, projects I have worked on, and how to contact me.",
        "portfolio.btn.demo": "Project Demo",
        "portfolio.btn.code": "Source Code",
        "portfolio.btn.web": "Visit Website",
        "gallery.item1.title": "First Steps",
        "gallery.item1.desc": "Remembering where it all started. Every little step counts.",
        "gallery.item2.title": "True Bonds",
        "gallery.item2.desc": "The best moments are lived in the best company. Unforgettable instances.",
        "gallery.item3.title": "Next Destination: Japan",
        "gallery.item3.desc": "A clear goal on the horizon. A culture I admire and a dream soon to be reality.",
        "gallery.item4.title": "Tech Community",
        "gallery.item4.desc": "I've had the chance to meet amazing people like Brais (MoureDev). Community learning is my engine.",
        "gallery.item5.title": "Pure Adrenaline",
        "gallery.item5.desc": "Stepping out of the comfort zone. I love extreme challenges, whether it's skydiving or fixing a tough bug.",
        "gallery.item6.title": "Leadership",
        "gallery.item6.desc": "During my degree I managed to build a great community. Growing as a team is key to success.",
        "gallery.item7.title": "Bachelor's Degree",
        "gallery.item7.desc": "Proud to have graduated with excellence, closing a flawless cycle at the Polytechnic.",
        "gallery.item8.title": "Adventurous Spirit",
        "gallery.item8.desc": "Traveling and discovering new places is my passion. Each destination is a new perspective of the world.",
        "footer.title": "Explore the depths",
        "footer.desc": "Thank you for diving into my portfolio. I'm always looking for new oceans of code to explore and challenging projects.",
        "footer.contact": "Let's talk about your next project!",
        "footer.copyright": "© 2026 Perucho Dev. All rights reserved.",
        "footer.lights": "Turn on the lights!"
    }
};
